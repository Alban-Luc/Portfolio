...
<template>
    ...
    <!-- Page travaux --> 
        ...
        <div id="travaux" class="py-20">
            <h1 class="text-6xl md:text-9xl font-bold">TRAVAUX</h1>
                    ...
                    <!-- <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <RouterLink to="/SML">
                                <div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                                    <div>
                                        <img class="object-center object-cover h-auto w-full" src="/src/components/icons/SML.png" alt="photo">
                                    </div>
                                    <div class="text-center py-8 sm:py-6">
                                        <p class="text-xl text-gray-700 font-bold mb-2">Share My Loc</p>
                                        <p class="text-base text-gray-400 font-normal">Application</p>
                                    </div>
                                </div>
                            </RouterLink>
                        ...
                        <div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                            <div>
                                <img class="object-center object-cover h-auto w-full" src="/src/components/icons/AquaSynchro.png" alt="photo">
                            </div>
                            <div class="text-center py-8 sm:py-6">
                                <p class="text-xl text-gray-700 font-bold mb-2">AquaSynchro</p>
                                <p class="text-base text-gray-400 font-normal">Application</p>
                            </div>
                        </div>
                        ...
                        <div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                            <div>
                                <img class="object-center object-cover h-auto w-full" src="/src/components/icons/Lofi.png" alt="photo">
                            </div>
                            <div class="text-center py-8 sm:py-6">
                                <p class="text-xl text-gray-700 font-bold mb-2">Lofi Style</p>
                                <p class="text-base text-gray-400 font-normal">Motion Design</p>
                            </div>
                        </div>
    ...
    <!-- Page contact -->
        ...
        <div id="contact">
            <h1 class="text-6xl md:text-9xl font-bold ">CONTACT</h1>

                <div class="w-full bg-menu h-screen">
                    <div class="bg-white h-96"></div>
                    <div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12">
                        <div class="w-full bg-white border-4 border-menu  shadow rounded p-8 sm:p-12 -mt-72">
                            <form action="" method="post">
                                <div class="md:flex items-center mt-12">
                                    <div class="w-full md:w-1/2 flex flex-col">
                                        <label class="font-semibold leading-none text-menu">Nom</label>
                                        <input type="text" class="leading-none text-menu p-3 mt-4 border-0 bg-gray-100 rounded" />
                                    </div>
                                    <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                                        <label class="font-semibold leading-none text-menu">Email</label>
                                        <input type="email" class="leading-none text-menu p-3 mt-4 border-0 bg-gray-100 rounded"/>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <button class="mt-9 font-semibold leading-none text-white py-4 px-10 bg-menu rounded hover:bg-logo">
                                        Envoyer
                                    </button>
                                </div>
                            </form>
...
<style>
    ...
    h1 {
        color: white;
        text-shadow: 1px 0 0 #505F98, 0 1px 0 #505F98, 0 -1px 0 #505F98, -1px 0 0 #505F98;

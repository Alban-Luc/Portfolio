...
<div class="bg-white">
  <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
    <div>
      ...
      <p class="mt-4 text-gray-500">Réaliser un site peremettant de se retrouver physiquement.
Le principe est simple, grace a la localisation de deux individu le site propose en temps réel un itinéraire pour se rejoindre.
A chaque top de temps l'itinéraire est recalculé en fonction des déplacements</p>
      ...
      <dl class="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-1 sm:gap-y-16 lg:gap-x-8">
        ...
        <div class="border-t border-gray-200 pt-4">
          ...
          <p class="mt-2 text-sm text-gray-500">Figma, Illustrator</p>
        </div>

        <div class="border-t border-gray-200 pt-4">
          <p class="font-medium text-gray-900">Lien</p>
          <div class="flex mt-2">
            <a href="https://www.behance.net/gallery/184419501/Share-my-loc" target="_blank">
